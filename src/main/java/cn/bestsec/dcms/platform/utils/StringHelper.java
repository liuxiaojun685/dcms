...
public final class StringHelper {
	...
	private final static String regex8 = "^((13[0-9])|(14[57])|(15[012356789])|(17[01678])|(18[0-9]))\\d{8}$";
	private final static String regex9 = "\\A([^@\\s]+)@((?:[-a-z0-9]+\\.)+[a-z]{2,})\\Z";
