 ...
 */
public class SystemConfig_QueryWatermarkConfigResponse extends CommonResponseFieldsSupport {
    ...
    public SystemConfig_QueryWatermarkConfigResponse() {
    }

    public SystemConfig_QueryWatermarkConfigResponse(Integer type, Integer left, Integer top, Integer right, Integer bottom, Integer fontSize, Integer colorA, String colorRGB, Integer fontEscapement, Integer markLocal, Integer markRows, Integer markCols, Integer compNameType, Integer userNameType, Integer hostAddrType, String fontName, String text, Integer markTop, Integer markLeft, Integer markRight, Integer markBottom, Integer printTimeType, List<Desensity> showWatermark) {
        this.type = type;
        this.left = left;
        this.top = top;
        this.right = right;
    ...
    public SystemConfig_QueryWatermarkConfigResponse(Integer code, String msg, Integer type, Integer left, Integer top, Integer right, Integer bottom, Integer fontSize, Integer colorA, String colorRGB, Integer fontEscapement, Integer markLocal, Integer markRows, Integer markCols, Integer compNameType, Integer userNameType, Integer hostAddrType, String fontName, String text, Integer markTop, Integer markLeft, Integer markRight, Integer markBottom, Integer printTimeType, List<Desensity> showWatermark) {
        this.code = code;
        this.msg = msg;
        this.type = type;
        this.left = left;
