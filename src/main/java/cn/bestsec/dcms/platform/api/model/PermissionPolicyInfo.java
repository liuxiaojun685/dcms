 ...
 */
public class PermissionPolicyInfo {
    private Integer fileState;
    private Integer fileLevel;
    private Integer roleType;
    private PermissionInfo permission;
    
    public PermissionPolicyInfo() {
    }

    public PermissionPolicyInfo(Integer fileState, Integer fileLevel, Integer roleType, PermissionInfo permission) {
