 ...
 */
public class Basis_UpdateBasisRequest extends CommonRequestFieldsSupport {
    private String token;
    private Integer basisId;
    private String basisName;
    
    public Basis_UpdateBasisRequest() {
    }

    public Basis_UpdateBasisRequest(String token, Integer basisId, String basisName) {
        this.token = token;
