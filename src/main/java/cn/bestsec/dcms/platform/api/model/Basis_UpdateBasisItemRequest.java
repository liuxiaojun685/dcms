 ...
 */
public class Basis_UpdateBasisItemRequest extends CommonRequestFieldsSupport {
    private String token;
    private Integer basisId;
    private Integer basisLevel;
    private String basisItem;
    
    public Basis_UpdateBasisItemRequest() {
    }

    public Basis_UpdateBasisItemRequest(String token, Integer basisId, Integer basisLevel, String basisItem) {
        this.token = token;
