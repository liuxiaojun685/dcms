...
function getInfoTable(result, filter) {
    ...
    var strinfo = '<div style="width:800px;margin:0 auto;background: #fff;"><table style="width:700px;margin:0 auto;border: 1px solid #4777c8;">' +
        ...
        '</tr>' +
        '<tr>' +
        '<td class="rowname" style="border-right:1px solid #4777c8"><span style="letter-spacing: 0;">主定密单位：</span><input style="width:560px;margin-left:3px;" type="text"readonly value="' + result.fileMajorUnit.name + '"/></td>' +
        '</tr>' +
        '<tr>' +
        '<td class="rowname" style="border-right:1px solid #4777c8"><span style="letter-spacing: 0;">辅定密单位：</span>' +
        '<div class="list-major-input" style="border-left: 0;height: 37px;display:inline-block;width: 80%;margin-left:3px;">' +
        ...
        '<textarea id="pid_basisDescription" style="width: 560px;height: 35px;overflow-y: auto;color:#000;margin-left:75px;"></textarea>' +
        //'</span>' +
        //'</div>' +
        //'</div>' +
        '</td>' +
