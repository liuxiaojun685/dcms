    ...
    $.ajax({
        ...
        success: function (result) {
            ...
            result.onSuccess = function () {
                var str1 = '<tr>' +
                    '<td>邮件告警定时配置起始时间:</td>' +
                    '<td class="mt"><input type="text" class="laydate-icon" id="MailAlarmStartTime" value="' + getMyDate(result.timerMailAlarmStartTime) + '" /></span></td>' +
                    '</tr>' +
                    '<tr>' +
                    '<td>邮件告警定时配置周期:</td>' +
                    '<td class="mp"><input style="width:50px;" type="number" value="' + parseInt(result.timerMailAlarmPeriod / 86400000) + '" onkeyup="control(event,this)"/><span>天</span></td>' +
                    '</tr>' +
                    '<tr>' +
                    '<td>数据库备份定时配置起始时间:</td>' +
                    '<td class="bt"><input type="text" class="laydate-icon" id="BackupStartTime"  value="' + getMyDate(result.timerBackupStartTime) + '"/></td>' +
                    '</tr>' +
                    '<tr>' +
                    '<td>数据库备份定时配置周期:</td>' +
                    '<td class="bp"><input style="width:50px;" type="number" value="' + parseInt(result.timerBackupPeriod / 86400000) + '" onkeyup="control(event,this)"/><span>天</span></td>' +
                    '</tr>' +
                    '<tr style="display:none;">' +
                    '<td>日志上传定时配置起始时间:</td>' +
                    '<td><input type="text" class="laydate-icon" id="ClientLogStartTime" value="' + getMyDate(result.timerClientLogStartTime) + '"/></td>' +
                    '</tr>' +
                    '<tr style="display:none;">' +
                    '<td>日志上传定时配置周期:</td>' +
                    '<td><input style="width:50px;" type="number" value="' + parseInt(result.imerClientLogPeriod / 86400000) + '" onkeyup="control(event,this)"/><span>天</span></td>' +
                    '</tr>' +
                    '<tr>' +
                    '<td>AD同步定时配置起始时间:</td>' +
                    '<td class="st"><input type="text" class="laydate-icon" id="AdSyncStartTime" value="' + getMyDate(result.timerAdSyncStartTime) + '"/></td>' +
                    '</tr>' +
                    '<tr>' +
                    '<td>AD同步定时配置周期:</td>' +
                    '<td class="sp"><input style="width:50px;" type="number" value="' + parseInt(result.timerAdSyncPeriod / 86400000) + '" onkeyup="control(event,this)"/><span>天</span></td>' +
                    '</tr>' +
                    '<tr>' +
                    '<td>文件自动解密定时配置起始时间:</td>' +
                    '<td class="at"><input type="text" class="laydate-icon" id="AutoDecodeStartTime" value="' + getMyDate(result.timerAutoDecodeStartTime) + '"/></td>' +
                    '</tr>' +
                    '<tr>' +
                    '<td>文件自动解密定时配置周期:</td>' +
                    '<td class="ap"><input style="width:50px;" type="number" value="' + parseInt(result.timerAutoDecodePeriod / 86400000) + '" onkeyup="control(event,this)"/><span>天</span></td>' +
                    '</tr>' +
                    '<tr style="display:none;">' +
                    '<td>密级文件统计定时配置起始时间:</td>' +
                    '<td><input type="text" class="laydate-icon" id="FileStatisticStartTime" value="' + getMyDate(result.timerFileStatisticStartTime) + '"/></td>' +
                    '</tr>' +
                    '<tr style=display:none;>' +
                    '<td>密级文件统计定时配置周期:</td>' +
                    '<td><input style="width:50px;" type="number" value="' + parseInt(result.timerFileStatisticPeriod / 86400000) + '" onkeyup="control(event,this)"/><span>天</span></td>' +
                    '</tr>' +
                    '<tr>' +
                    '<td>取消审批代理人权限定时配置起始时间:</td>' +
                    '<td class="ct"><input type="text" class="laydate-icon" id="CancelApproverStartTime" value="' + getMyDate(result.timerCancelApproverStartTime) + '"/></td>' +
                    '</tr>' +
                    '<tr>' +
                    '<td>取消审批代理人权限定时配置周期:</td>' +
                    '<td class="cp"><input style="width:50px;" type="number" value="' + parseInt(result.timerCancelApproverPeriod / 86400000) + '" onkeyup="control(event,this)"/><span>天</span></td>' +
                    '</tr>' +
                    '<tr>' +
