            ...
            result.onSuccess = function () {
                ...
                for (var i = 0; i < result.backupList.length; i++) {
                    ...
                    var str = '<tr>' +
                        ...
                        '<td>' + result.backupList[i].name + '</td>' +
                        '<td>' + result.backupList[i].description + '</td>' +
                        '<td>' + result.backupList[i].createFrom + '</td>' +
                        '<td>' + getMyDate(result.backupList[i].createTime) + '</td>' +
                        '<td>' + bytesToSize(result.backupList[i].size) + '</td>' +
                        '<td>' + result.backupList[i].location + '</td>' +
