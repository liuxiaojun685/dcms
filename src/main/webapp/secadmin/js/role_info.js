        ...
        success: function (data) {
            data.onSuccess = function () {
                ...
                for (var i = 0; i < datas.length; i++) {
                    ...
                    str += '</td>' +
                        '<td><a href="javaScript:;;" onclick="queryScope(this.id)" id="' + datas[i].roleId + '" style=""><span>可视范围</span></a></td>' +
                        '<td><a href="javaScript:;;"><i class="fa fa-save" onclick="saveRolelevel(this)"></i></a><span style="padding: 0 10px;"></span><a href="javaScript:;;"><i class="fa fa-trash-o" onclick="delTr(this)"></i></a></td>' +
                        '</tr>';
                    $("#tab").append(str);
                }
            }
