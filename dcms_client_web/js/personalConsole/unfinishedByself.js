...
function setValues(result,s){
    ...
    var str = '<td class="rowname" style="border-right:1px solid #000;"><span>审批信息：</span>' +
        '<table style="display: inline-block;vertical-align: middle;width:600px;margin-left:7px;" class="table table-bordered">' +
        '<thead style="width:600px;">'+
        '<tr>'+
        '<th style="width:10%;text-align: center">审批级别</th>'+
        '<th style="width:10%;text-align: center">审批人姓名</th>'+
        '<th style="width:10%;text-align: center">审批状态</th>'+
        '<th style="width:30%;text-align: center">审批时间</th>'+
        '<th style="width:40%;text-align: center">审批意见</th>'+
        '</tr>'+
...
function applyfValidPeriod(result,s){
    ...
    if(result.durationType==2){
        var str = '<input type="text" id="ftime" readonly style="margin-right: 5px;width: 36px;float: left;margin-left: 5px; border-radius: 3px; border: 0; margin-top: 3px; height: 20px;" >' +
    ...
    if(result.durationType==4){
        ...
        var str='<input id="durationDescription" style="width: 70%;margin-left: 5px;height: 23px" readonly type="text" value="'+result.durationDescription+'">';
    }
    $("."+s+"times").empty();
    $("."+s+"times").append(str)
        ...
        $.ajax({
            ...
            success:function(result){
                ...
                if(result.code==0){
                    ...
                    var str = '姓名:<select id="approverStep">' ;
...
function select(t){
    ...
    var val=$(t).val();
    if(val==2){
        var str = '<input type="text" id="time" style="margin-right: 5px;width: 36px;display:inline-block;margin-left: 5px; border-radius: 3px; border: 1px solid #ddd; margin-top: 3px; height: 20px;" >' +
            '<select id="time2" style="display:inline-block;width: 36px;" ><option>年</option><option>月</option><option>日</option></select>';

    }
    if(val==3){
        var str='<input style="margin-left: 5px;height: 23px" type="text" class="laydate-icon" id="start" onclick="getTime()">';
    }
    if(val==4){

        var str='<input id="durationDescription" style="width: 70%;margin-left: 5px;height: 23px" type="text">';
    }
    $(".times").empty();
    $(".times").append(str)
...
function applyValidPeriod(result){
    ...
    if(result.durationType==2){
        var str = '<input type="text" id="time" style="margin-right: 5px;display:inline-block;margin-left: 5px; border-radius: 3px; border: 1px solid #ddd; margin-top: 3px; height: 20px;" >' +
            '<select id="time2" style="display:inline-block;" ><option>年</option><option>月</option><option>日</option></select>';

    }
    if(result.durationType==3){
        var str='<input style="margin-left: 5px;height: 23px" type="text" class="laydate-icon" id="start" onclick="getTime()" value="'+getDate(result.fileDecryptTime)+'">';
    }
    if(result.durationType==4){

        var str='<input id="durationDescription" style="margin-left: 5px;height: 23px" type="text" value="'+result.durationDescription+'">';
    }
    $(".times").empty();
    $(".times").append(str)
...
function initData(dispatch){
    ...
    if(dispatch.contentRead==1){
        str+= '<span>内容阅读</span><input style="border:0;" type="checkbox"  name="contentRead" checked>';
    }else{
        str+= '<span>内容阅读</span><input style="border:0;" type="checkbox"  name="contentRead" >';
    }
    if(dispatch.contentPrint==1){
        str+= '<span>内容打印</span><input style="border:0;" value="1" type="checkbox"  name="contentPrint" checked>';
    }else{
        str+= '<span>内容打印</span><input style="border:0;" value="1" type="checkbox"  name="contentPrint" >';
    }
    if(dispatch.contentPrintHideWater==1){
        str+= '<span>打印隐藏水印</span><input style="border:0;" type="checkbox"  name="contentPrintHideWater" checked>';
    }else{
        str+= '<span>打印隐藏水印</span><input style="border:0;" type="checkbox"  name="contentPrintHideWater" >';
    }
    if(dispatch.contentModify==1){
        str+= '<span>内容修改</span><input style="border:0;" type="checkbox"  name="contentModify" checked>';
    }else{
        str+= '<span>内容修改</span><input style="border:0;" type="checkbox"  name="contentModify" >';
    }
    if(dispatch.contentScreenShot==1){
        str+= '<span>内容截屏</span><input style="border:0;" type="checkbox"  name="contentScreenShot" checked>';
    }else{
        str+= '<span>内容截屏</span><input style="border:0;" type="checkbox"  name="contentScreenShot" >';
    }
    if(dispatch.contentCopy==1){
        str+= '<span>内容拷贝</span><input style="border:0;" type="checkbox"  name="contentCopy" checked>';
    }else{
        str+= '<span>内容拷贝</span><input style="border:0;" type="checkbox"  name="contentCopy" >';
    }
    if(dispatch.fileCopy==1){
        str+= '<span>文件拷贝</span><input style="border:0;" type="checkbox"  name="fileCopy" checked>';
    }else{
        str+= '<span>文件拷贝</span><input style="border:0;" type="checkbox"  name="fileCopy" >';
    }

    if(dispatch.fileSaveCopy==1){
        str+= '<span>另存副本</span><input style="border:0;" type="checkbox"  name="fileSaveCopy" checked>';
    }else{
        str+= '<span>另存副本</span><input style="border:0;" type="checkbox"  name="fileSaveCopy" >';
    }
    $(".permission").empty();
...
function createCheckBox(){
    var str = '<div class="checkbox">'+
        ...
        '<label>'+
        '<input type="checkbox"  name="contentScreenShot">打印时隐藏水印'+
        '</label>'+
        '<label>'+
