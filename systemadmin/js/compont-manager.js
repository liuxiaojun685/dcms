            ...
            data.onSuccess = function () {
                ...
                for (var i = 0; i < data.componentList.length; i++) {
                    ...
                    var str = '<tr>' +
                        ...
                        '<td class="text-center" style="display: none">' + data.componentList[i].componentId + '</td>' +
                        '<td class="text-center">' + data.componentList[i].name + '</td>' +
                        '<td class="text-center">' + data.componentList[i].description + '</td>' +
                        select +
                        '<td class="text-center"><a href="javaScript:;;"><i onclick="save(this)" class="fa fa-save"></i></a></td>' +
                        '</tr>';
                    $(".list").append(str);
                }
            }
