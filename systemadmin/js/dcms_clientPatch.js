        ...
        success: function (result) {
            result.onSuccess = function () {
                ...
                for (var i = 0; i < result.patchList.length; i++) {
                    ...
                    var str = '<tr>' +
                        '<td class="text-center"><input type="checkbox" name="ckb"></td>' +
                        ...
                        '<td class="text-center">' + isUndefined(result.patchList[i].location) + '</td>' +
                        '<td class="text-center">' + bytesToSize(isUndefined(result.patchList[i].size)) + '</td>' +
                        '<td class="text-center">' + isUndefined(result.patchList[i].osType) + '</td>' +
                        '<td class="text-center">' + versionType + '</td>' +
                        '<td class="text-center">' + isUndefined(result.patchList[i].versionCode) + '</td>' +
                        '<td class="text-center">' + isUndefined(result.patchList[i].versionName) + '</td>' +
                        '<td class="text-center">' + getLocalTime(result.patchList[i].createTime) + '</td>' +
                        '<td class="text-center"><a onclick="allInfo(' + result.patchList[i].patchId + ')" href="#"><i class="fa fa-list"></i></a></td>' +
                        '</tr>';
            ...
            result.onSuccess = function () {
                ...
                for (var i = 0; i < result.uninstallPasswdList.length; i++) {
                    var str = '<tr>' +
                        ...
                        '<td class="text-center">' + isUndefined(result.uninstallPasswdList[i].passwd) + '</td>' +
                        '<td class="text-center">' + isUndefined(result.uninstallPasswdList[i].syncNum) + '</td>' +
                        '<td class="text-center">' + isUndefined(result.uninstallPasswdList[i].unsyncNum) + '</td>' +
                        '<td class="text-center">' + isUndefined(result.uninstallPasswdList[i].description) + '</td>' +
                        '<td class="text-center">' + getLocalTime(result.uninstallPasswdList[i].createTime) + '</td>' +
                        '</tr>';
