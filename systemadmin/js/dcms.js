            ...
            result.onSuccess = function () {
                ...
                for (var i = 0; i < datas.length; i++) {
                    ...
                    if(datas[i].isHaveRole == 1){
                    	...
                    	str+='<td class="text-center"><input type="checkbox" disabled="disabled"></td>' ;
                    }else{
                    	str+='<td class="text-center"><input type="checkbox" name="ckb"></td>' ;
                    }
                        str+='<td class="text-center">' + num + '</td>' +
                        '<td style="display:none;">' + datas[i].uid + '</td>' +
                        '<td class="text-center">' + datas[i].account + '</td>' +
                        '<td class="text-center">' + datas[i].name + '</td>' +
                        '<td class="text-center">' + datas[i].level + '</td>' +
                        '<td class="text-center">' + datas[i].departmentName + '</td>' +
                        '<td class="text-center">' + datas[i].state + '</td>' +
                        '<td class="text-center">' + datas[i].online + '</td>' +
                        '<td class="all text-center" onclick="allList(this)" style="cursor: pointer;"><a href="javaScript:;;"><i' +
