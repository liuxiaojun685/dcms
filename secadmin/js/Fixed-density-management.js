                ...
                if (datas != undefined) {
                    for (var i = 0; i < datas.length; i++) {
                        ...
                        var str = '<tr>' +
                            ...
                            '<td class="text-center"><input id="class'+datas[i].basisId+'" type="text" value="' + datas[i].basisClass + '" class="form-control' +
                            ' text-center"' +
            ...
            if (datas != undefined) {
                for (var i = 0; i < datas.length; i++) {
                    ...
                    var str = '<tr>' +
                        '<td class="text-center">' + num + '</td>' +
                        '<td style="display:none;">' + datas[i].basisId + '</td>' +
                        '<td class="text-center"><input id="basis'+datas[i].basisId+'" type="text" value="' + datas[i].basisName + '" class="form-control' +
                        ' text-center"' +
                        ' style="padding:3px;"/></td>' +
                ...
                if (datas != undefined) {
                    for (var i = 0; i < datas.length; i++) {
                        ...
                        var str = '<tr>' +
                            '<td class="text-center">' + num + '</td>' +
                            '<td style="display:none;">' + datas[i].basisId + '</td>' +
                            '<td class="text-center"><select id="basisLevel'+datas[i].basisId+'">';
                        ...
                        if(datas[i].basisLevel==4){
                            ...
                            str+='</select></td>'+
                            '<td class="text-center"><input id="item'+datas[i].basisId+'" type="text" value="' + datas[i].basisItem + '" class="form-control' +
                            ' text-center"' +
                            ' style="padding:3px;"/></td>' +
                            '<td class="text-center"><a href="javascript:void(0)"><i class="fa fa-trash-o" style="margin-left:10px;" onclick="delItem('+datas[i].basisId+','+type+','+parentId+')"></i></a><a href="javascript:void(0)"><i class="fa fa-save" style="margin-left:10px;" onclick="updateItem('+datas[i].basisId+','+type+','+parentId+')"></i></a></td>' +
                            '</tr>';
                        if(type==0){
                    		$(".item0").append(str);
                    	}
