            ...
            result.onSuccess = function () {
                ...
                for (var i = 0; i < result.unitList.length; i++) {
                    var str = '<tr>' +
                        ...
                        '<td class="text-center">' + result.unitList[i].unitNo + '</td>' +
                        '<td class="text-center">' + result.unitList[i].name + '</td>' +
                        '<td class="text-center">' + result.unitList[i].description + '</td>' +
                        '<td class="text-center"><a href="javaScript:;;"><i class="fa fa-trash-o" onclick="delTr(this)"/></i></a></td>' +
                        '</tr>';
                    $("#tab").append(str);
                }
                //添加辅助定密单位
