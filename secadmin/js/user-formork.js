            ...
            result.onSuccess = function () {
                ...
                for (var i = 0; i < datas.length; i++) {
                    ...
                    var str = '<tr>' +
                        ...
                        '<td class="text-center">' + isUndefined(datas[i].name) + '</td>' +
                        '<td class="text-center">' + level + '</td>' +
                        '<td class="text-center">' + isUndefined(datas[i].departmentName) + '</td>' +
                        '<td style="display:none;">' + datas[i].state + '</td>' +
                        '<td class="text-center">' + datas[i].online + '</td>' +
                        '<td class="all text-center" onclick="allList(this)" style="cursor: pointer;"><a href="#"><i' +
