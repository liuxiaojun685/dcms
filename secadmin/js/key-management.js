...
$(function () {
    ...
    $("#box_tab1 .process").css("max-height",height);
    $("#box_tab2 .process").css("max-height",height);
    InitTable();
});
//将时间戳转化为时间
function add0(m) {
                ...
                if (datas.length > 0) {
                    for (var i = 0; i < datas.length; i++) {
                        ...
                        var str = '<tr>' +
                            ...
                            '<td class="text-center">' + datas[i].keyId + '</td>' +
                            '<td class="name text-center">' + datas[i].keyName + '</td>' +
                            '<td class="text-center">' + datas[i].keyLength + '</td>' +
                            '<td class="text-center">' + datas[i].admin.account + '</td>' +
                            '<td class="text-center">' + da + '</td>' +
                            '<td class="text-center">' + createFrom + '</td>' +
