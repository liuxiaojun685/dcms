        ...
        success: function (result) {
            result.onSuccess = function () {
                ...
                var str = '<tr>' +
                    ...
                    '<td><input type="text" value="' + parseInt(isUndefined(data[4].validPeriod)) + '" onkeyup="control(event,this)"/><span style="color:red;">*(单位为：年，为整数)</span>  <span style="padding:0 10px;"></span><a href="javaScript:;;"><i class="fa fa-save" onclick="xiugai(this)"></i></a></td>' +
                    '</tr>' +
                    '<tr>' +
                    '<td>机密级默认保密期限设置:</td>' +
                    '<td style="display:none;">' + data[3].fileLevel + '</td>' +
                    '<td><input type="text" value="' + parseInt(isUndefined(data[3].validPeriod)) + '" onkeyup="control(event,this)"/><span style="color:red;">*(单位为：年，为整数)</span> <span style="padding:0 10px;"></span><a href="javaScript:;;"><i class="fa fa-save" onclick="xiugai(this)"></i></a></td>' +
                    '</tr>' +
                    '<tr>' +
                    '<td>秘密级默认保密期限设置:</span></td>' +
                    '<td style="display:none;">' + data[2].fileLevel + '</td>' +
                    '<td><input type="text" value="' + parseInt(isUndefined(data[2].validPeriod)) + '" onkeyup="control(event,this)"/><span style="color:red;">*(单位为：年，为整数)</span> <span style="padding:0 10px;"></span><a href="javaScript:;;"><i class="fa fa-save" onclick="xiugai(this)"></i></a></td>' +
                    '</tr>' +
                    '<tr>' +
                    '<td>内部级默认保密期限设置:<span style="color:red;"></span></td>' +
                    '<td style="display:none;">' + data[1].fileLevel + '</td>' +
                    '<td><input type="text" value="' + parseInt(isUndefined(data[1].validPeriod)) + '" onkeyup="control(event,this)"/><span style="color:red;">(单位为：年，为整数)可为空</span> <span style="padding:0 10px;"></span><a href="javaScript:;;"><i class="fa fa-save" onclick="xiugai(this)"></i></a></td>' +
                    '</tr>' +
                    '<tr>' +
                    '<td style="background: #efefef">公开级默认保密期限设置:</td>' +
                    '<td style="display:none;">' + data[0].fileLevel + '</td>' +
                    '<td><input type="text" value="' + parseInt(isUndefined(data[0].validPeriod)) + '" onkeyup="control(event,this)"/><span style="color:red;">(单位为：年，为整数)可为空</span> <span style="padding:0 10px;"></span><a href="javaScript:;;"><i class="fa fa-save" onclick="xiugai(this)"></i></a></td>' +
                    '</tr>';
