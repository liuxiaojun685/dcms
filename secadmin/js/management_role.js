            ...
            data.onSuccess = function () {
                ...
                for (var i = 0; i < roletype.length; i++) {
                    ...
                    var str = '<tr>' +
                        ...
                        '<td class="text-center">' + adminType + '</td>' +
                        '<td style="display:none;">' + roletype[i].aid + '</td>' +
                        '<td class="text-center">' + roletype[i].description + '</td>' +
                        '<td class="text-center">' + roletype[i].account + '</td>' +
                        '<td class="text-center">' + roletype[i].createFrom + ' </td>' +
                        '<td class="text-center"><a href="#" onclick="alllist('+roletype[i].adminType+')"><i class="fa fa-list"></i></a></td>' +
                        '</tr>';
                    $("#tab").append(str);
        ...
        success: function (data) {
            ...
            data.onSuccess = function () {
                ...
                for (var m = 0; m < queryDeriveAdmin.length; m++) {
                    str1 += '<tr>' +
                        '<td class="text-center">' + parseInt(m + 1) + '</td>' +
                        '<td style="display:none;">' + queryDeriveAdmin[m].aid + '</td>' +
                        '<td style="display:none;">' + queryDeriveAdmin[m].uid + '</td>' +
                        '<td class="text-center">' + queryDeriveAdmin[m].account + '</td>' +
                        '<td class="text-center">' + queryDeriveAdmin[m].name + '</td>' +
                        '<td class="text-center">' + queryDeriveAdmin[m].parentAdmin + '</td>' +
                        '<td class="text-center"><a href="#" onclick="delTr(this,'+adminType+')"><i class="fa fa-trash-o"></i></a></td>' +
                        '</tr>';
                }
